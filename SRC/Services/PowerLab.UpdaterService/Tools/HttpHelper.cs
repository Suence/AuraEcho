...
namespace PowerLab.UpdaterService.Tools
{
    public class HttpHelper
    {
        ...
        /// 上传文件
        /// </summary>
        public async Task<string?> PostFileAsync(string url, string filePath, string fieldName = "file")
        {
            try
            {
                using var form = new MultipartFormDataContent();
                form.Add(new StreamContent(File.OpenRead(filePath)), fieldName, Path.GetFileName(filePath));
